---
# checklist-xxx
id: checklist-task-implement-knowledge-anchor-add-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implement-knowledge-anchor-add-ready-for-closeout
- condition-task-implement-knowledge-anchor-add-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
