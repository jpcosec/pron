...
Runs `sldb stores update` to reindex every tracked document (semantic index, sections), then semantic-exports the store and ingests it into the KGDB snapshot at .sldb/runtime/knowledge.nx.json.
