...
## 8. Servir el mundo: un proceso lo mantiene abierto y los demás le hablan por un socket
...
**A cargo de la aplicación.** Lanzar y detener el servidor, y decidir quién puede tocar el socket.
