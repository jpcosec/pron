...
class Kernel:
    ...
    def dry_run(
        ...
        if v is None:
            ...
            p = self._dry_load(export_id, overlay)
            return self._dry_save(export_id, model, p, overlay)
        return v.dry(self, export_id, field_name, value, overlay)
