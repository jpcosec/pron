"""One word of the lexicon (spec 05): its form, what it names as a form (pron.sexpr.forms.refs,
...
class Word:
    ...
    ref: str  # what the word names, as a form (pron.sexpr.forms.refs, spec 13): (model M), (relation R), …
    motive: str
